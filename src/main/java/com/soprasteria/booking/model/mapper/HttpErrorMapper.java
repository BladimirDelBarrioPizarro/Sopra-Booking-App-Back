...
public class HttpErrorMapper {
    ...
    public static ResponseEntity<HttpErrorDTO> buildHttpErrorDTO(Integer code, HttpStatus internalServerError, String contextPath, String message, String method, Throwable cause, Timestamp timestamp) {
